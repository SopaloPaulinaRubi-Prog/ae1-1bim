#Sistema de facturación de libros
...
# Pregunta pricipal del programa

def ejecutar_sistema_ventas():
    
    print("--- Sistema de Registro de Ventas de Libros ---")
    
    # Preguntar cuántas ventas se desean realizar
    while True:
        try:
    ...
    # Ciclo para registrar múltiples clientes
    i = 0
    while i < num_ventas:
    ...
    print("\n\n" + "#"*60)
    print("          🛍️ REPORTE FINAL DE VENTAS REGISTRADAS ")
    print("#"*60)
    
    # Mostrar informacion de las compras
